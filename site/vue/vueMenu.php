...
public function afficherPlanningEnt(){
	...
	<div id="main">
		<br/>Bonjour,
		<br/><br/>Bienvenue sur votre espace utilisateur créé à l'occasion des rencontres alternances du <?=$dateEvenement?>.

		<br/><br/>Les emplois du temps relatifs à cet événement, le vôtre y compris, n'ont toujours pas été générés. L'administrateur vous en informera lorsque ceux-ci seront disponibles.
		<br/><br/>
	</div>
		<?php
		echo $util->generePied();
