...
class VueAuthentification{
	...
	public function genereVueAuthentification($erreur){ 
		...
		<p>
			<span>Entreprises, étudiants, nous vous proposons d'échanger à l'occasion de cette journée "Rencontres Alternance".</span>
			<br/><br/>
			<?php
			$dao = new Dao();
